...
INSERT INTO `langue` VALUES (1,'fran'),(2,'anglais');
...
INSERT INTO `utilisateur` VALUES (1,'durantay','quentin','qentin@gmail.com',1),(2,'dupont','marie','marie@hotmail.fr',1),(3,'miller','vincent','vm@yahoo.com',2),(4,'zuckerberg','marc','marc@gmail.com',2),(5,'paul','pierre','pp@orange.fr',1),(6,'de vauclerc','lisa','lisadv@gmail.com',1),(7,'gluntig','','glunt@sfr.com',1),(8,'cavill','henry','henry@outlook.fr',2),(9,'hopper','lionel','hpp@gmail.com',2),(10,'tember','fabienne','fabienne@yopmail.com',1);
...
--
-- Final view structure for view `aliment_bio_vw`
--
...
/*!50001 VIEW `aliment_bio_vw` AS select `aliment`.`id` AS `id`,`aliment`.`nom` AS `nom`,`aliment`.`marque` AS `marque`,`aliment`.`sucre` AS `sucre`,`aliment`.`calories` AS `calories`,`aliment`.`graisses` AS `graisses`,`aliment`.`proteines` AS `proteines`,`aliment`.`bio` AS `bio` from `aliment` where (`aliment`.`bio` = false) order by `aliment`.`proteines` desc */;
...
-- Dump completed on 2026-06-25 11:26:01
